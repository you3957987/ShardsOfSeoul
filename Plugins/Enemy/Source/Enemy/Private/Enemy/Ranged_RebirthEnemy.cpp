...
ARanged_RebirthEnemy::ARanged_RebirthEnemy()
{
...
void ARanged_RebirthEnemy::AfterDieMontageEnd()
{
...
void ARanged_RebirthEnemy::SpawnSoul()
{
	bIsActiveSoul = true;
	...
	GetWorld()->GetTimerManager().SetTimer(
	  ...
	  this,                   // 호출할 객체
	  &ARanged_RebirthEnemy::Revive, // 호출할 함수 주소
	  ReviveDelayTime,        // 지연 시간
	  false                   // 반복 여부 (false = 1회만 실행)
	 );
}

void ARanged_RebirthEnemy::Revive()
{
