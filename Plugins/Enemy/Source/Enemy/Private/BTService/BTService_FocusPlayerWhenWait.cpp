#include "BTService/BTService_FocusPlayerWhenWait.h"

#include "AIController.h"
#include "BaseEnemy.h"
#include "BehaviorTree/BlackboardComponent.h"

UBTService_FocusPlayerWhenWait::UBTService_FocusPlayerWhenWait()
{
	NodeName = TEXT("Focus Player When Wait");
}

void UBTService_FocusPlayerWhenWait::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
