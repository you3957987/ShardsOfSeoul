#include "EnemyBoss/Hechi/BTTask_HechiLaser.h"

#include "AIController.h"
#include "EnemyBoss/Hechi/Hechi.h"

UBTTask_HechiLaser::UBTTask_HechiLaser()
{
...
EBTNodeResult::Type UBTTask_HechiLaser::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	CurrentAttackMontage = Boss->StartLaserAttack();
	bIsAttacking = true;
...
void UBTTask_HechiLaser::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
