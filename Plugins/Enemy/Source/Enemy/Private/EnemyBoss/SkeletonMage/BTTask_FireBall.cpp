...
void UBTTask_FireBall::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	...
	if (Boss && !Boss->GetMesh()->GetAnimInstance()->Montage_IsPlaying(Boss->FireBallMontage))
	{
