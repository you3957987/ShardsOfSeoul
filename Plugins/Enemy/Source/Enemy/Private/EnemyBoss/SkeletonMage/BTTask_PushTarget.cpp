...
{
	NodeName = "SkeletonMagePushTarget";
...
void UBTTask_PushTarget::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	...
	if (Boss && !Boss->GetMesh()->GetAnimInstance()->Montage_IsPlaying(Boss->PushTargetMontage))
	{
