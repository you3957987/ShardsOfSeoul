#include "EnemyBoss/MagicSwordMan/BTTask_MagicSwordManGuardCounter.h"
...
EBTNodeResult::Type UBTTask_MagicSwordManGuardCounter::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	CurrentAttackMontage = Boss->StartGuardReactionAttack();
	bIsAttacking = true;
...
void UBTTask_MagicSwordManGuardCounter::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
