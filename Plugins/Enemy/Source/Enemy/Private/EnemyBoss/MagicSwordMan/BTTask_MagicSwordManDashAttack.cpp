#include "EnemyBoss/MagicSwordMan/BTTask_MagicSwordManDashAttack.h"
...
EBTNodeResult::Type UBTTask_MagicSwordManDashAttack::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	CurrentAttackMontage = Boss->StartDashAttack();
	bIsAttacking = true;
...
void UBTTask_MagicSwordManDashAttack::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
